...
$versions = array ();
$versions[] = array(
	'name' => 'HostCMS.Халява v. 6.0.x',
	'url' => 'http://www.hostcms.ru/download/6/HostCMS.Free_6.1.tar.gz'
);
$versions[] = array(
	'name' => 'HostCMS.Халява v. 5.9.x',
	'url' => 'http://www.hostcms.ru/download/5/HostCMS.Free_5.9.tar.gz'
);
	...
	<div id="id_content" class="hostcmsWindow">
		<div id="authorization">
			<div id="form">
				...
				{
				?>
				<p><strong>Загрузка и распаковка системы управления сайтом HostCMS</strong></p>
				...
				<form name="authorization" action="./install.php" method="post">
					...
					<p style="margin-top: 20px"><strong>Выберите редакцию системы управления сайтом:</strong></p>

					<?php
					foreach ($versions as $key => $value)
					{
						$checked = !$key ? 'checked=""' : '';
						?><p><label><input type="radio" <?php echo $checked ?> name="cms_version" value="<?php echo $key ?>" style="margin-bottom: 6px;"><?php echo $value['name']?></label></p>
						<?php
					}
					...
					?><div style="margin: 10px 0 0 0;"><input name="install" class="start" type="submit" value="Загрузить"/></div><?php
					?>
				</form>
				<?php
				}
		...
		<div id="footer">
			<div id="copyright">&copy; 2005–2012 ООО «Хостмэйк»</div>
			<div id="links">
				<p>Официальный сайт HostCMS:  <a href="http://www.hostcms.ru" target="_blank">www.hostcms.ru</a></p>
				<p>Служба технической поддержки:  <a href="mailto:support@hostcms.ru">support@hostcms.ru</a></p>
			</div>
		</div>
	</body>
	</html>
